          	...
          	<div class="row mt">
          		<div class="col-lg-12">
          			<div class="form-panel">
   			         ...
   			         <table class="table table-bordered table-hover" id="listRateTbl">
				                      <thead>
				                      	    		...
				                      	    		<tr class='<%=isFail?"danger text-white":"" %>'>
				                      	    			...
				                      	    			<td style="text-align: center;">
					                      	    			<%if(!isFail){%>
																  ...
																  <modong:sys-permission function="ViewExchangeRateAuto">
						                      	    			  <s:url var="viewURL"   action="prepareViewExchangeRateAutoByAuto">
